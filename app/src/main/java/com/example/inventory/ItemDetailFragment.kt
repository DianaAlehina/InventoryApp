    ...
    private fun bind(item: Item) {
        ...
        binding.apply {
            ...
            if (!sharedPreferences.getBoolean("CheckBoxHide",false)){
                ...
                providerPhone.transformationMethod = HideReturnsTransformationMethod.getInstance();
            }
            else {
                ...
                providerPhone.transformationMethod = PasswordTransformationMethod.getInstance();
            }
            providerName.text = item.providerName
            providerEmail.text = item.providerEmail
            providerPhone.text = item.providerPhone
